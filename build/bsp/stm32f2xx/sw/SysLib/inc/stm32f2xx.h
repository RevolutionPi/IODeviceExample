...
#define DMA_SxFCR_FEIE                       ((uint32_t)0x00000080)	// FIFO Over/Underrun Enable
#define DMA_SxFCR_FS                         ((uint32_t)0x00000038) // FIFO Status
#define DMA_SxFCR_FS_0                       ((uint32_t)0x00000008) // FIFO Status Bit 0
#define DMA_SxFCR_FS_1                       ((uint32_t)0x00000010) // FIFO Status Bit 1
#define DMA_SxFCR_FS_2                       ((uint32_t)0x00000020) // FIFO Status Bit 2
#define DMA_SxFCR_DMDIS                      ((uint32_t)0x00000004) // Direct Mode Disable
#define DMA_SxFCR_FTH                        ((uint32_t)0x00000003) // FIFO Threshold
#define DMA_SxFCR_FTH_0                      ((uint32_t)0x00000001) // FIFO Threshold Bit 0
#define DMA_SxFCR_FTH_1                      ((uint32_t)0x00000002) // FIFO Threshold Bit 1

/********************  Bits definition for DMA_LISR register  *****************/ 
#define DMA_LISR_TCIF3                       ((uint32_t)0x08000000) // Low Transfer Complete Interrupt Flag
#define DMA_LISR_HTIF3                       ((uint32_t)0x04000000) // Low Half Transfer Complete Interrupt Flag
#define DMA_LISR_TEIF3                       ((uint32_t)0x02000000) // Low Transfer Error
#define DMA_LISR_DMEIF3                      ((uint32_t)0x01000000) // Low Direct Mode Error
#define DMA_LISR_FEIF3                       ((uint32_t)0x00400000) // Low FIFO error
#define DMA_LISR_TCIF2                       ((uint32_t)0x00200000)	// Low Transfer Complete Interrupt Flag
...
/********************  Bits definition for DMA_HISR register  *****************/ //DMA high interrupt status register (DMA_HISR)
#define DMA_HISR_TCIF7                       ((uint32_t)0x08000000)	// High Transfer Complete Interrupt Flag
#define DMA_HISR_HTIF7                       ((uint32_t)0x04000000)	// High Half Transfer Complete Interrupt Flag
#define DMA_HISR_TEIF7                       ((uint32_t)0x02000000)	// High Transfer Error Interrupt Flag
#define DMA_HISR_DMEIF7                      ((uint32_t)0x01000000) // High Direct Mode Error
#define DMA_HISR_FEIF7                       ((uint32_t)0x00400000) // High FIFO Error Interrupt
...
/********************  Bits definition for DMA_LIFCR register  ****************/ // DMA low interrupt flag clear register (DMA_LIFCR)
#define DMA_LIFCR_CTCIF3                     ((uint32_t)0x08000000) // Low Clear Transfer Complete Bit
#define DMA_LIFCR_CHTIF3                     ((uint32_t)0x04000000) // Low Clear Half Transfer Bit
#define DMA_LIFCR_CTEIF3                     ((uint32_t)0x02000000) // Low Clear Transfer Error
#define DMA_LIFCR_CDMEIF3                    ((uint32_t)0x01000000) // Low Clear Direct Mode Error
#define DMA_LIFCR_CFEIF3                     ((uint32_t)0x00400000) // Low Clear FIFO Error Flag
#define DMA_LIFCR_CTCIF2                     ((uint32_t)0x00200000) // Low Clear Transfer Complete
...
#define  TIM_CR2_MMSIM_0                       ((uint16_t)0x0010)            /*!<Bit 0 */
#define  TIM_CR2_MMSIM_1                       ((uint16_t)0x0020)            /*!<Bit 1 */
#define  TIM_CR2_MMSIM_2                       ((uint16_t)0x0040)            /*!<Bit 2 */
